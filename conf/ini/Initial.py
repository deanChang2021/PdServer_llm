...
from conf.ini.IniConfig import IniConfig
...
def initialSysConfig():
    ...
    ai = {'chatModel': 'qwen2.5',
          'mathModel': 'qwen2-math',
          'midjourneyImgUrl':'https://cnaigc.net/woowoS-0.1/midjourney/imagine',
          'getMidjourneyImgUrl':'https://cnaigc.net/woowoS-0.1/midjourney/mjPicture',
          'midjourneyImgToken':''}
