...
class LLM:
    ...
    def chatPoem(self, poem : str) -> Union[PoemInfo, None]:
        ...
        #"你好，请你作为一个语文老师。请你帮我从下面的的文章中，提取作者、作者年代、创作时间，以及内容的详细解读，解读至少需要有200字。并且，你还需要完成一个任务，请你根据文章的大意，将诗词分为多个画面镜头，并为每个画面镜头编写prompt，这些prompt的风格需要符合文章的时代背景与风格，并且需要是英语，我需要使用这些prompt用于midjourney生成图片，每一个prompt不能少于50个汉字。文章会被三个#符号包围。\n###{book_introduction}###")
